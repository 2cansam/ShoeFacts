...
public class Methods extends ShoeArrayList {

    public Shoe.Builder createJordan1() {
    ...
    public static void createJordan2() {
    ...
    public static void createJordan3() {
    ...
    public static void createJordan4() {
    ...
    public static void createJordan5() {
    ...
    public static void createJordan6() {
    ...
    public static void createJordan7() {
    ...
    public static void createJordan8() {
    ...
    public static void createJordan9() {
    ...
    public static void createJordan10(){
    ...
    public static void createJordan11() {
    ...
    Scanner sc = new Scanner(System.in);
        ...
        try {
            ...
            if (input.equalsIgnoreCase("Jordan 1")) {
                System.out.println(createJordan1());
